...
impl From<ClientRenderBackendAggregate> for TelemetryClientRenderBackendSummary {
    fn from(aggregate: ClientRenderBackendAggregate) -> Self {
        Self {
            graphics_backend: aggregate.graphics_backend,
            count: aggregate.count,
        }
    }
}
