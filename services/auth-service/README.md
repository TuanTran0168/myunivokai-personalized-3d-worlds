...
or a job. See [notes/plans/services/auth-and-admin-plan.md](../../notes/plans/services/auth-and-admin-plan.md).
...
[notes/skills/admin-key-rotation-drill.md](../../notes/skills/admin-key-rotation-drill.md)
...
[notes/plans/architecture/service-wake-mechanism.md](../../notes/plans/architecture/service-wake-mechanism.md).
