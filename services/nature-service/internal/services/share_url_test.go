...
// /nature/share/worlds/{slug}. Every share link ever handed out was a 404.
//
...
const (
	shareURLTestPublicWebURL   = "https://myunivokai.test/nature"
	shareURLTestExpectedPrefix = "https://myunivokai.test/nature/share/worlds/"
)
...
func newShareURLTestWorldService(publicWebURL string) *WorldService {
	...
	return NewWorldService(serviceConfig, repositories.NewMemoryStore(), NewForestConfigBuilder())
}
