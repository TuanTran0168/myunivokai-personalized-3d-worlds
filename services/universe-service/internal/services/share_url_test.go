...
// /universe/share/worlds/{slug}. Every share link ever handed out was a 404.
//
...
const (
	shareURLTestPublicWebURL   = "https://myunivokai.test/universe"
	shareURLTestExpectedPrefix = "https://myunivokai.test/universe/share/worlds/"
)
...
func newShareURLTestWorldService(publicWebURL string) *WorldService {
	...
	return NewWorldService(serviceConfig, repositories.NewMemoryStore(), NewWorldConfigBuilder())
}
