...
pub use telemetry::{
    ...
    TelemetryComparison, TelemetryDelta, TelemetryErrorCodeCount, TelemetryFunnelStage,
    TelemetryHistogram, TelemetryHourBucket, TelemetryOverviewQueryData,
    ...
    CLIENT_RENDER_OUTCOME_WEBGL_FAILED, CLIENT_RENDER_TIER_BALANCED, CLIENT_RENDER_TIER_HIGH,
    CLIENT_RENDER_TIER_MINIMAL, TELEMETRY_DEFAULT_HOURS, TELEMETRY_FUNNEL_STAGE_ACCEPTED,
