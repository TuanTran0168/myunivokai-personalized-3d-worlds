...
//! the cost `agent-system/evolution/rust-adoption-research.md` named plainly before any
...
pub use telemetry::{
    ...
    telemetry_histogram_index_of, telemetry_rollup_message_id, CacheBucket, ClientRenderBucket,
    HttpRollupBucket, HttpRollupData, HttpRollupEnvelope, NatsBackendBucket,
    TelemetryBackendSummary, TelemetryCacheSummary, TelemetryClientRenderBackendSummary,
    TelemetryClientRenderSummary, TelemetryComparison, TelemetryDelta, TelemetryErrorCodeCount,
    ...
    TelemetryVolumePoint, CLIENT_RENDER_BACKEND_UNKNOWN, CLIENT_RENDER_BACKEND_WEBGL,
    CLIENT_RENDER_BACKEND_WEBGL2, CLIENT_RENDER_BACKEND_WEBGPU, CLIENT_RENDER_FAMILIES,
    CLIENT_RENDER_OUTCOME_RENDERED, CLIENT_RENDER_OUTCOME_WEBGL_FAILED,
    CLIENT_RENDER_TIER_BALANCED, CLIENT_RENDER_TIER_HIGH, CLIENT_RENDER_TIER_MINIMAL,
    TELEMETRY_DEFAULT_HOURS, TELEMETRY_FUNNEL_STAGE_ACCEPTED, TELEMETRY_FUNNEL_STAGE_RECEIVED,
    TELEMETRY_FUNNEL_STAGE_SERVED, TELEMETRY_HISTOGRAM_BUCKET_COUNT,
