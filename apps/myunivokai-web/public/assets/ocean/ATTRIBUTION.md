...
same route the nature-1 catalogue took. `agent-system/knowledge/frontend/3d-development-limitations.md`
...
`agent-system/knowledge/references/threejs-assets.md`.
