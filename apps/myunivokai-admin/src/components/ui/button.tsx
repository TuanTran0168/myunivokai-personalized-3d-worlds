...
const buttonVariants = cva(
  ...
  // `cursor: default` on every <button>, so a button reads as non-interactive
  // on hover unless it says otherwise. `disabled:cursor-not-allowed` still
  // matters despite `disabled:pointer-events-none`: an `aria-disabled`
  // button (Base UI's pattern for keeping focus) is not pointer-events-none.
