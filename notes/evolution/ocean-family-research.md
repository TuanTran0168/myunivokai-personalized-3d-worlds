...
> approved [city-service-plan.md](../plans/services/city-service-plan.md) — is made on evidence
...
> [ocean-service-plan.md](../plans/services/ocean-service-plan.md), which is the document to
...
| Click a creature to focus | `shared/CameraRig.tsx` + `shared/PlanetPositionTracker.ts` | **Zero changes.** A new family writes positions into the same Map and camera focus works — stated in [threejs-scene-architecture.md](../knowledge/frontend/threejs-scene-architecture.md) and true in source |
...
| GLB normalisation + compression | `forest/forestModels.ts` `normalizationForObject`, and the gltf-transform Draco pipeline in [forest-render-mechanism.md](../knowledge/frontend/forest-render-mechanism.md) | Reuse as is |
...
recorded in [forest-render-mechanism.md](../knowledge/frontend/forest-render-mechanism.md).
...
- **Abyssal creatures are the known gap.** There is no agent-downloadable CC0
  ...
  [threejs-assets.md](../knowledge/references/threejs-assets.md). Three exits: build
...
[ambient-audio-mechanism.md](../knowledge/frontend/ambient-audio-mechanism.md) is satisfied by
...
[city-service-plan.md](../plans/services/city-service-plan.md) applies unchanged and is the
...
[auth-analytics-first-deploy-checklist.md](../skills/auth-analytics-first-deploy-checklist.md).
...
| Planning state | This document only | **[city-service-plan.md](../plans/services/city-service-plan.md) approved**, Sprint 3 starts **2026-08-19** |
...
| --- | --- | --- | --- |
| Modern / Western | [Kenney City Kit](https://kenney.nl/assets/city-kit-commercial), [KayKit City Builder Bits](https://github.com/KayKit-Game-Assets/KayKit-City-Builder-Bits-1.0) | **CC0** | ✅ (already verified in [threejs-assets.md](../knowledge/references/threejs-assets.md)) |
...
[forest-render-mechanism.md](../knowledge/frontend/forest-render-mechanism.md). Self-hosting
...
Following the convention of [README.md](../plans/architecture/README.md) §What must not happen:
...
- Do not add a field to `contracts.WorldSnapshot` without adding the matching
  ...
  [analytics-service-plan.md](../plans/services/analytics-service-plan.md).
