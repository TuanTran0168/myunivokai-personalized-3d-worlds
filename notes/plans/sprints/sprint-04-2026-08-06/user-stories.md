...
Source evidence:
- notes/plans/services/auth-and-admin-plan.md — §Phases, Phase 0
- notes/rules/ci-quality-gates.md — the contract job the new lint step was added to
...
Source evidence:
- notes/plans/services/auth-and-admin-plan.md — §auth-service (Tokens, Passwords, Schema)
- notes/plans/services/auth-and-admin-plan.md — §Owner decisions, decision 2
...
Source evidence:
- notes/plans/services/auth-and-admin-plan.md — §The admin app
...
Source evidence:
- notes/plans/services/auth-and-admin-plan.md — §Lockout guards
- notes/plans/services/auth-and-admin-plan.md — §Phases, Phase 7
...
- [x] Run and document a key-rotation drill with two active public keys (`notes/skills/admin-key-rotation-drill.md`).
...
Source evidence:
- notes/plans/services/auth-and-admin-plan.md — §Phases, Phase 8
...
- notes/plans/services/analytics-service-plan.md — §Phases, Phase 0
...
Source evidence:
- notes/plans/services/analytics-service-plan.md — §Design decision: a revision column on worlds
- notes/plans/services/analytics-service-plan.md — §The event gap
- notes/plans/services/analytics-service-plan.md — §Phases, Phase 1
...
- notes/plans/services/analytics-service-plan.md — §What the existing infrastructure already provides (`dnaResultsDurableName` precedent)
- notes/plans/services/analytics-service-plan.md — §Phases, Phase 2
...
Source evidence:
- notes/plans/services/analytics-service-plan.md — §Query contract
- notes/plans/services/analytics-service-plan.md — §Phases, Phase 3
...
Source evidence:
- notes/plans/services/analytics-service-plan.md — §Admin request path
- notes/plans/services/analytics-service-plan.md — §Changes this forces in auth-and-admin-plan.md
- notes/plans/services/analytics-service-plan.md — §Phases, Phase 4
...
Source evidence:
- notes/plans/services/analytics-service-plan.md — §Phases, Phase 5
- notes/plans/services/analytics-service-plan.md — §What this costs
...
Source evidence:
- notes/plans/services/auth-and-admin-plan.md — §Charts
- notes/plans/services/analytics-service-plan.md — §Phases, Phase 6
