...
Source evidence:
- notes/plans/services/telemetry-service-plan.md — §Rust contracts, §Phases (phase 0)
- notes/evolution/rust-adoption-research.md — §Re-scoring Track C's four criteria, criterion 3
...
Source evidence:
- notes/plans/services/telemetry-service-plan.md — §Gateway-side work (Go), §Durability and wake
- notes/evolution/platform-evolution-research.md — §B2, the cardinality rule
- notes/evolution/telemetry-architecture-research.md — §The number that was missing
...
Source evidence:
- notes/plans/services/telemetry-service-plan.md — §The `TelemetrySink` trait, §Phases (phase 2)
...
Source evidence:
- notes/plans/services/telemetry-service-plan.md — §Data model, §What this service tracks
...
Source evidence:
- notes/plans/services/telemetry-service-plan.md — §The `TelemetrySink` trait, §Admin surface
...
Source evidence:
- notes/plans/services/telemetry-service-plan.md — §Admin surface
...
Source evidence:
- notes/plans/services/telemetry-service-plan.md — §Deploy and CI additions
- notes/skills/auth-analytics-first-deploy-checklist.md — why no new NATS user is needed in production
...
- [x] Add every new variable to `.env.example`, and the "why one service is not Go" paragraph to `notes/knowledge/backend/source-overview.md`.
