...
will go red. Read all three before writing code — together they are shorter than
any single document in `knowledge/`.
...
| [ci-quality-gates.md](ci-quality-gates.md) | The GitHub Actions jobs every PR must pass. |
