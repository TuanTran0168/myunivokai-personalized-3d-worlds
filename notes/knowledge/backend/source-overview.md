...
`notes/plans/services/analytics-service-plan.md`.
...
`notes/plans/services/telemetry-service-plan.md`. Runbook and deviations:
...
`notes/evolution/platform-evolution-research.md` set out to find one service worth
...
identity for the admin console (`notes/plans/services/auth-and-admin-plan.md`).
