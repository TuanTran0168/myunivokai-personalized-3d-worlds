...
- [notes/evolution/rust-adoption-research.md](../../evolution/rust-adoption-research.md) — why this service and not another
- [notes/plans/services/telemetry-service-plan.md](../../plans/services/telemetry-service-plan.md) — the approved design
- [notes/knowledge/backend/source-overview.md](source-overview.md) — where this sits in the backend
