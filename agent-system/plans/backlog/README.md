...
acceptance evidence live beside each dated sprint in `agent-system/sprints/*/user-stories.md`.

## Documents

| Document | Purpose |
| --- | --- |
| [implemented-capabilities.md](../../knowledge/product/implemented-capabilities.md) | What the current product already supports, expressed as verifiable stories |
...
- [Vision V1 solution architecture](../architecture/v1-2026-07-22/solution-architecture.md) — NATS, Redis,
  DNA/family boundaries, data ownership and scale model.
- [City Service implementation plan](../services/city-service-plan.md) — third
  family, now implemented on the new platform only after Sprints 1–2.
- [Auth-service and internal admin app plan](../services/auth-and-admin-plan.md)
  and [Analytics-service plan](../services/analytics-service-plan.md) — Sprint 4,
  in that priority order.
- [Telemetry-service plan](../services/telemetry-service-plan.md) — Sprint 5,
...
- Every task follows `agent-system/rules/git-convention.md`; one concern per PR from
  `staging`.
