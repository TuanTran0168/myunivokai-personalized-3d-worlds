...
`agent-system/user-stories` folder is now an index and cross-sprint product backlog;
...
[the production guide](../../../skills/production-deployment-guide.md) records the
...
2026-08-07 in
[the production guide §1](../../../skills/production-deployment-guide.md); the
...
[frontend-modernization-research.md](../../../evolution/frontend-modernization-research.md):
