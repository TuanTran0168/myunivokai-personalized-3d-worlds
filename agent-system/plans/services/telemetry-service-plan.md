...
> [rust-adoption-research.md](../../evolution/rust-adoption-research.md) and
> [telemetry-architecture-research.md](../../evolution/telemetry-architecture-research.md).
...
- No new NATS user needed for Synadia production — one shared `nats.creds`
  ...
  `agent-system/skills/auth-analytics-first-deploy-checklist.md` for why). A local-only
...
- `agent-system/knowledge/backend/source-overview.md` gets one paragraph: the backend is Go except
