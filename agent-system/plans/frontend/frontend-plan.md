...
> flow is defined in [Vision V1 solution architecture](../architecture/v1-2026-07-22/solution-architecture.md).

Part of the [vision folder](../architecture/README.md). This plan describes the source that
...
[../fe/threejs-scene-architecture.md](../../knowledge/frontend/threejs-scene-architecture.md)
§Family chunks.
