...
[../fe/threejs-scene-architecture.md](../frontend/threejs-scene-architecture.md):
...
- [agent-system/evolution/rust-adoption-research.md](../../evolution/rust-adoption-research.md) — why this service and not another
- [agent-system/plans/services/telemetry-service-plan.md](../../plans/services/telemetry-service-plan.md) — the approved design
- [agent-system/knowledge/backend/source-overview.md](source-overview.md) — where this sits in the backend
