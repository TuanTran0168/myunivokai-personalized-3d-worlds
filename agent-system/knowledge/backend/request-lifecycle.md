...
[telemetry-service-plan.md](../../plans/services/telemetry-service-plan.md).
...
Full rationale: [analytics-service-plan.md](../../plans/services/analytics-service-plan.md).
...
[service-wake-mechanism.md](../../plans/architecture/service-wake-mechanism.md), which records
